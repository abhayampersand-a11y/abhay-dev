...
/** Shared props: reveal a block the first time it scrolls into view. */
const inView = {
  ...
  return (
    <div className="flex gap-0.5 mb-5" aria-label="5 out of 5 stars">
      {Array.from({ length: 5 }).map((_, i) => (
        <motion.svg
          key={i}
          className="w-4 h-4 text-accent-light fill-current"
          viewBox="0 0 20 20"
          aria-hidden="true"
  ...
  return (
    <main>
      ...
      <section id="hero" className="relative min-h-screen flex items-center pt-16 overflow-hidden">
        <motion.div
          className="absolute top-1/4 right-0 w-96 h-96 bg-violet-500/15 rounded-full blur-3xl pointer-events-none"
          aria-hidden="true"
          animate={{ scale: [1, 1.2, 1], opacity: [0.6, 1, 0.6] }}
          transition={{ duration: 9, repeat: Infinity, ease: "easeInOut" }}
        />
        <motion.div
          className="absolute bottom-1/4 left-0 w-72 h-72 bg-blue-500/15 rounded-full blur-3xl pointer-events-none"
          aria-hidden="true"
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-24 w-full">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <motion.div variants={container} initial="hidden" animate="show">
              <motion.p variants={item} className="inline-flex items-center gap-2 text-sm font-medium text-accent-light tracking-wide mb-5">
              ...
              <motion.p variants={item} className="text-base text-zinc-500 dark:text-zinc-400 mb-3">
                Hi, I&apos;m Abhay Desai — <span className="text-zinc-700 dark:text-zinc-200 font-medium">Full Stack Developer</span>
              </motion.p>
              <motion.h1 variants={item} className="font-display font-bold text-4xl md:text-5xl lg:text-6xl leading-[1.08] tracking-tight text-zinc-900 dark:text-white mb-6">
                Building Scalable Web Applications for Businesses That Want to <span className="text-grad">Grow</span>
              </motion.h1>
              <motion.p variants={item} className="text-lg text-zinc-500 dark:text-zinc-400 font-light leading-relaxed max-w-lg mb-10">
              ...
              <motion.div variants={item} className="flex gap-8 mt-14 pt-8 border-t border-zinc-100 dark:border-zinc-900">
                {[
                  { n: "25+", l: "Projects delivered" },
                  { n: "18+", l: "Happy clients" },
                  { n: "3+", l: "Years experience" },
                ].map((s) => (
                  <div key={s.l}>
                    <p className="font-display font-bold text-3xl text-zinc-900 dark:text-white">{s.n}</p>
            ...
            >
              ...
              >
                ...
                <motion.div
                  className="absolute -bottom-4 -left-4 bg-grad text-white font-display font-bold text-sm px-4 py-2.5 rounded-2xl shadow-lg"
          ...
          <motion.div {...inView} variants={fadeUp} className="mt-16 pt-8 border-t border-zinc-100 dark:border-zinc-900">
      ...
      <section id="services" className="py-24 bg-zinc-50 dark:bg-zinc-900/40">
        <div className="max-w-6xl mx-auto px-6">
          <motion.div {...inView} variants={container} className="mb-14 max-w-2xl">
            <motion.p variants={item} className="text-xs font-medium text-accent-light tracking-widest uppercase mb-3">What I do</motion.p>
            <motion.h2 variants={item} className="font-display font-bold text-4xl md:text-5xl text-zinc-900 dark:text-white mb-4">Business solutions, not just code</motion.h2>
            <motion.p variants={item} className="text-zinc-500 dark:text-zinc-400 leading-relaxed">I build software that solves real problems — helping you automate operations, serve customers better, and increase revenue.</motion.p>
          </motion.div>
          <motion.div {...inView} variants={container} className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <ServiceCard title="Custom Website Development" body="Fast, SEO-ready websites built with Next.js that load instantly and rank well — turning visitors into paying customers." useCase="A restaurant site that doubled online reservations.">
            ...
            <ServiceCard title="Web Application Development" body="Full-featured web apps with secure logins, dashboards and real-time data — so you can digitise manual processes and serve customers 24/7." useCase="A clinic booking platform with patient portals.">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
            </ServiceCard>
            <motion.article variants={item} whileHover={{ y: -6 }} className="group bg-zinc-900 dark:bg-zinc-800 rounded-2xl p-8 border border-zinc-800 hover:border-accent relative overflow-hidden">
            ...
            <ServiceCard title="Admin Dashboard Development" body="Clean, data-rich dashboards to run your whole operation from one screen — make faster decisions with live metrics." useCase="A sales & inventory dashboard for a retail chain.">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
            </ServiceCard>
            <ServiceCard title="API Development" body="Robust, well-documented REST APIs with NestJS / Node.js that power web, mobile and third-party integrations — so your product scales and connects." useCase="A payment + notification API for an e-commerce app.">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
            </ServiceCard>
            <ServiceCard title="Database Design (PostgreSQL)" body="Reliable, well-modelled PostgreSQL schemas with Prisma that keep your data fast and consistent — scale without performance headaches." useCase="Modelling orders, users & payments for a marketplace.">
            ...
            <motion.article variants={item} whileHover={{ y: -6 }} className="group bg-white dark:bg-zinc-900 rounded-2xl p-8 border border-zinc-100 dark:border-zinc-800 hover:border-accent lg:col-span-3 lg:flex lg:items-center lg:gap-8">
      ...
      <section id="work" className="py-24">
        <div className="max-w-6xl mx-auto px-6">
          <motion.div {...inView} variants={container} className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-14">
            <div>
              <motion.p variants={item} className="text-xs font-medium text-accent-light tracking-widest uppercase mb-3">Portfolio</motion.p>
              <motion.h2 variants={item} className="font-display font-bold text-4xl md:text-5xl text-zinc-900 dark:text-white">Real business systems I&apos;ve built</motion.h2>
            </div>
            <motion.div variants={item}>
              <Link href="/projects" className="text-sm font-medium text-zinc-500 dark:text-zinc-400 hover:text-accent transition-colors self-start sm:self-auto nl">All projects →</Link>
            </motion.div>
          </motion.div>

          <motion.div {...inView} variants={container} className="grid md:grid-cols-2 gap-6">
            <motion.article variants={item} whileHover={{ y: -6 }} className="group rounded-2xl overflow-hidden bg-zinc-100 dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 hover:border-accent md:row-span-2">
              <div className="pf w-full h-64 md:h-80 overflow-hidden">
                <motion.div className="w-full h-full" whileHover={{ scale: 1.05 }} transition={{ duration: 0.4, ease: EASE }}>
      ...
      <section id="about" className="py-24 bg-zinc-50 dark:bg-zinc-900/40">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <motion.div {...inView} variants={container} className="order-1 md:order-2">
              <motion.p variants={item} className="text-xs font-medium text-accent-light tracking-widest uppercase mb-3">About me</motion.p>
              <motion.h2 variants={item} className="font-display font-bold text-4xl md:text-5xl text-zinc-900 dark:text-white leading-tight mb-6">I turn business problems<br />into working software</motion.h2>
              <motion.p variants={item} className="text-zinc-500 dark:text-zinc-400 leading-relaxed mb-4">I&apos;m Abhay Desai, a freelance Full Stack Developer who helps startups, local businesses and entrepreneurs build software that actually moves the needle. From a simple marketing website to a full SaaS platform, I focus on results — more bookings, faster operations, and a better experience for your customers.</motion.p>
              <motion.p variants={item} className="text-zinc-500 dark:text-zinc-400 leading-relaxed mb-8">I work end-to-end: clean, modern frontends with Next.js and React, solid backends with Node.js and NestJS, and reliable PostgreSQL databases. You get clear communication, on-time delivery, and code that&apos;s built to scale as your business grows.</motion.p>
              <motion.div variants={item}>
      ...
      <section id="reviews" className="py-24">
        <div className="max-w-6xl mx-auto px-6">
          <motion.div {...inView} variants={container} className="mb-14">
            <motion.p variants={item} className="text-xs font-medium text-accent-light tracking-widest uppercase mb-3">Social proof</motion.p>
            <motion.h2 variants={item} className="font-display font-bold text-4xl md:text-5xl text-zinc-900 dark:text-white">What clients say</motion.h2>
          </motion.div>
          <motion.div {...inView} variants={container} className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <motion.blockquote variants={item} whileHover={{ y: -6 }} className="bg-zinc-50 dark:bg-zinc-900 rounded-2xl p-7 border border-zinc-100 dark:border-zinc-800">
              <Stars />
            ...
            <motion.blockquote variants={item} whileHover={{ y: -6 }} className="bg-zinc-900 dark:bg-zinc-800 rounded-2xl p-7 border border-zinc-800 relative overflow-hidden">
      ...
      <section id="blog" className="py-24 bg-zinc-50 dark:bg-zinc-900/40">
        <div className="max-w-6xl mx-auto px-6">
          <motion.div {...inView} variants={container} className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-14">
            <div>
              <motion.p variants={item} className="text-xs font-medium text-accent-light tracking-widest uppercase mb-3">Insights</motion.p>
              <motion.h2 variants={item} className="font-display font-bold text-4xl md:text-5xl text-zinc-900 dark:text-white">From the blog</motion.h2>
            </div>
            <motion.div variants={item}>
              <Link href="/blog" className="text-sm font-medium text-zinc-500 dark:text-zinc-400 hover:text-accent transition-colors self-start sm:self-auto nl">All articles →</Link>
            </motion.div>
          </motion.div>
          <motion.div {...inView} variants={container} className="grid md:grid-cols-3 gap-6">
            {blogPosts.map((post) => (
              <motion.article key={post.slug} variants={item} whileHover={{ y: -6 }} className="group bg-white dark:bg-zinc-900 rounded-2xl overflow-hidden border border-zinc-100 dark:border-zinc-800 hover:border-accent">
                <div className="pf w-full h-44 overflow-hidden">
                  <motion.div className="w-full h-full" whileHover={{ scale: 1.05 }} transition={{ duration: 0.4, ease: EASE }}>
      ...
      <section id="contact" className="py-24">
        <div className="max-w-6xl mx-auto px-6">
          <motion.div
            {...inView}
            variants={fadeUp}
            className="bg-zinc-900 dark:bg-zinc-800 rounded-3xl p-10 md:p-16 relative overflow-hidden"
          >
            <motion.div
              className="absolute top-0 right-0 w-64 h-64 bg-violet-500/25 rounded-full blur-3xl pointer-events-none"
              aria-hidden="true"
              animate={{ scale: [1, 1.2, 1], opacity: [0.7, 1, 0.7] }}
              transition={{ duration: 10, repeat: Infinity, ease: "easeInOut" }}
            />
            <motion.div
              className="absolute bottom-0 left-0 w-48 h-48 bg-blue-500/20 rounded-full blur-3xl pointer-events-none"
              aria-hidden="true"
            ...
            <div className="relative z-10 grid md:grid-cols-2 gap-12 items-start">
              <motion.div {...inView} variants={container}>
                <motion.p variants={item} className="text-xs font-medium text-accent-light tracking-widest uppercase mb-3">Get in touch</motion.p>
                <motion.h2 variants={item} className="font-display font-bold text-4xl md:text-5xl text-white leading-tight mb-5">Let&apos;s build something<br />that grows your business</motion.h2>
                <motion.p variants={item} className="text-zinc-400 leading-relaxed mb-8">Whether you need a website, a custom web app, or a system to automate your operations — tell me about it and I&apos;ll get back to you within 24 hours.</motion.p>
                ...
                <form action="#" method="POST" noValidate>
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                      <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} type="submit" className="shimmer flex-1 bg-grad text-white font-display font-bold text-sm py-3.5 rounded-xl hover:brightness-110 transition-all">Send message →</motion.button>
...
function ServiceCard({
  ...
  return (
    <motion.article variants={item} whileHover={{ y: -6 }} className="group bg-white dark:bg-zinc-900 rounded-2xl p-8 border border-zinc-100 dark:border-zinc-800 hover:border-accent">
      <div className="w-12 h-12 flex items-center justify-center bg-indigo-50 dark:bg-zinc-800 rounded-xl mb-6 group-hover:bg-accent/10 transition-colors">
...
function WorkCard({
  ...
  return (
    <motion.article variants={item} whileHover={{ y: -6 }} className="group rounded-2xl overflow-hidden bg-zinc-100 dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 hover:border-accent">
      <div className="pf w-full h-48 overflow-hidden">
        <motion.div className="w-full h-full" whileHover={{ scale: 1.05 }} transition={{ duration: 0.4, ease: EASE }}>
